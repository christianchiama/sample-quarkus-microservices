package org.cchiama.services.department.controller;

import io.quarkus.test.junit.QuarkusTest;
import org.junit.jupiter.api.Test;
import org.cchiama.services.department.model.Department;
import org.cchiama.services.department.repository.DepartmentRepository;
...
public class DepartmentControllerTests {
    ...
    public void testInvalidAdd() {
        Department department = new Department(2L, "Test5");
        given().contentType("application/json").body(department).when().post("/departments").then().statusCode(200);
    }
